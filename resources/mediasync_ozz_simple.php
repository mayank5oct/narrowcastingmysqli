...
# Do RSYNC work
 ...
 ob_start();
 passthru("rsync -avzr -e \"ssh -p 63811\" --progress --timeout=10 --log-file=/var/www/html/narrowcasting/logs/rsync.log --files-from=/var/www/html/narrowcasting/$sync_file TPS@77.95.101.115:/var/www/html/narrowcasting /var/www/html/narrowcasting", $exit_code);
ob_end_clean();

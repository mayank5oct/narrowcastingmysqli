        ...
        for ($c=0; $c < $num; $c++) {
            ...
            if($c==3){
                ...
                $month = date('M', strtotime($date_field));
                  ...
                  $month_a = date('m', strtotime($date_field));
...
// "Data : ".$data[5];
        ...
        //if($rows_count==0){
         ...
         if(trim(addslashes($new_array[$i][2]))!=trim($data[4])){
            $query .= "line2 = "."'$data[4]'".",";
         }
         if(trim(addslashes($new_array[$i][3]))!=trim($data[3])){
            $query .= "line3 = "."'$data[3]'".",";
         }
         if(trim(addslashes($new_array[$i][4]))!=trim($data[5])){
            $query .= "line4 = "."'$data[5]'".",";
         }

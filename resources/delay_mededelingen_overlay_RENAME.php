 ...
 //exit;
   ...
   if(isset($_POST[$option1]) && $_POST[$option1]=='emergency'){     
	...
	$delay_text_1 = $getCordinates['not_present_1'];
	 ...
	 $delay_text_1 = $getCordinates['delay_text_1'] ." ". $_POST[$minutes1] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	...
	$delay_text_2 = $getCordinates['emergency_2'];
	 ...
	 $delay_text_2 = $getCordinates['delay_text_2'] ." ". $_POST[$minutes2] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	...
	$delay_text_3 = $getCordinates['emergency_3'];
	 ...
	 $delay_text_3 = $getCordinates['delay_text_3'] ." ". $_POST[$minutes3] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	...
	$delay_text_4 = $getCordinates['emergency_4'];
	 ...
	 $delay_text_4 = $getCordinates['delay_text_4'] ." ". $_POST[$minutes4] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	...
	$delay_text_5 = $getCordinates['emergency_5'];
	 ...
	 $delay_text_5 = $getCordinates['delay_text_5'] ." ". $_POST[$minutes5] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	...
	$delay_text_6 = $getCordinates['emergency_6'];
	 ...
	 $delay_text_6 = $getCordinates['delay_text_6'] ." ". $_POST[$minutes6] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	...
	/*if($_POST['emergency_'.$number]!='on'){	
	 if($minutes_2 != '' && $minutes_2 != '0'){
	  $delay_text_2 = $getCordinates['delay_text_2'] ." ". $_POST['minutes_2_'.$number] ." minuten uit. Wij vragen hiervoor uw begrip.";
	 }else{
	  $delay_text_2 = $getCordinates['non_delay_text_2'];
	 }
	 }else{
	...
	if($minutes_3 != '' && $minutes_3 != '0'){
	 $delay_text_3 = $getCordinates['delay_text_3'] ." ". $_POST['minutes_3_'.$number] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	 $delay_text_3 = $getCordinates['non_delay_text_3'];
	}
	 }else{
	...
	if($minutes_4 != '' && $minutes_4 != '0'){
	 $delay_text_4 = $getCordinates['delay_text_4'] ." ". $_POST['minutes_4_'.$number] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	 $delay_text_4 = $getCordinates['non_delay_text_4'];
	}
	 }else{
	...
	if($minutes_5 != '' && $minutes_5 != '0'){
	 $delay_text_5 = $getCordinates['delay_text_5'] ." ". $_POST['minutes_5_'.$number] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	 $delay_text_5 = $getCordinates['non_delay_text_5'];
	}
	 }else{
	...
	if($minutes_6 != '' && $minutes_6 != '0'){
	 $delay_text_6 = $getCordinates['delay_text_6'] ." ". $_POST['minutes_6_'.$number] ." minuten uit. Wij vragen hiervoor uw begrip.";
	}else{
	 $delay_text_6 = $getCordinates['non_delay_text_6'];
	}
	 ...
	 $delay_text_6 = $getCordinates['emergency_6'];
        ...
        $LINE_MARGIN=array($line_height1,$line_height2,$line_height3,$line_height4,$line_height5,$line_height6);
	$previousField=0;
   ...
   $Querytemp =   "insert into temp_delay_mededelingen
					 ...
					 template_id,line1,color1,font1,line2,color2,font2,line3,color3,font3,line4,color4,font4,line5,
                                         color5,font5,line6,color6,font6,temp_image_name,write_image_path,text_center1,text_center2,text_center3,
					 text_center4,text_center5,text_center6,minutes_1,minutes_2,minutes_3,minutes_4,minutes_5,minutes_6,is_emergency1,is_emergency2,is_emergency3,is_emergency4,is_emergency5,is_emergency6,not_present_1,not_present_2,not_present_3,not_present_4,not_present_5,not_present_6,is_minutes1,is_minutes2,is_minutes3,is_minutes4,is_minutes5,is_minutes6
					)
					...
					'$tempfont5','$templine6','$tempcolor6','$tempfont6','$temp_name','$write_image_path',
					$text_center1,$text_center2,$text_center3,$text_center4,$text_center5,$text_center6,'".$minutes_1."','".$minutes_2."','".$minutes_3."','".$minutes_4."','".$minutes_5."','".$minutes_6."',$is_emergency1,$is_emergency2,$is_emergency3,$is_emergency4,$is_emergency5,$is_emergency6,$not_present_1,$not_present_2,$not_present_3,$not_present_4,$not_present_5,$not_present_6,$is_minutes1,$is_minutes2,$is_minutes3,$is_minutes4,$is_minutes5,$is_minutes6 )";
						  
						  
	
    $conn=$db->query($Querytemp);
    $temp_mededelingen_id=mysql_insert_id($db->Link_ID_PREV);
    $check_emergency_query="select tmpmed.is_emergency1, tmpmed.is_emergency2, tmpmed.is_emergency3, tmpmed.is_emergency4, tmpmed.is_emergency5, tmpmed.is_emergency6,tmpmed.not_present_1,tmpmed.not_present_2,tmpmed.not_present_3,tmpmed.not_present_4,tmpmed.not_present_5,tmpmed.not_present_6 from temp_delay_mededelingen as tmpmed  where tmpmed.id=$temp_mededelingen_id limit 1";
   ...
   $minutes_6=$tempresulta['minutes_6'];
    ...
    if($tempresult_delete){
     ...
     $updateQueryTemp =  "update temp_delay_mededelingen set
		           ...
		           color6='$tempcolor6',font6='$tempfont6',text_center1=$text_center1,text_center2=$text_center2,text_center3=$text_center3
			   ,text_center4=$text_center4,text_center5=$text_center5,text_center6=$text_center6,minutes_1='".$minutes_1."',minutes_2='".$minutes_2."'
			   ,minutes_3='".$minutes_3."',minutes_4='".$minutes_4."',minutes_5='".$minutes_5."',minutes_6='".$minutes_6."',
			   temp_image_name='$temp_name',write_image_path='$write_image_path',is_emergency1='$is_emergency1',is_emergency2='$is_emergency2',is_emergency3='$is_emergency3',is_emergency4='$is_emergency4',is_emergency5='$is_emergency5',is_emergency6='$is_emergency6', not_present_1='$not_present_1', not_present_2='$not_present_2', not_present_3='$not_present_3', not_present_4='$not_present_4', not_present_5='$not_present_5', not_present_6='$not_present_6', is_minutes1='$is_minutes1', is_minutes2='$is_minutes2', is_minutes3='$is_minutes3', is_minutes4='$is_minutes4', is_minutes5='$is_minutes5', is_minutes6='$is_minutes6' where id=$temp_mededelingen_id";
 ...
 <?php }?>
   ...
   <?php }?>
	...
	$qy= "select a.*, b.id as clientid, b.is_active from delay_mededelingen as a, clients as b where a.client_id=b.id and b.is_active=1 and a.theatre_id in (select id from theatre where status = '1') order by a.id asc";
	 ...
	 while($template_qy_result =mysql_fetch_array($get_qy_templates, MYSQL_ASSOC)){
